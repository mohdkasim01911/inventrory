...
@section('content')
  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
        ...
        <form class="forms-sample" action="{{ route('paybles.store') }}" method="POST" >
            @csrf
           ...
           <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="amount" class="form-control @error('amount') is-invalid @enderror" id="amount" placeholder="Amount">
